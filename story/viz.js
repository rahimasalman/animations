...
const dataset = [{"title":"live within 50mi of a nuclear plant for a year (Bu asagidaki hallarda qebul etdiyiniz radiasiya miqdarini gosterir:1 il erzinde 50 mil (~80 km) nuve stansiyasi yaxinliginda yasamaq)", "measurement": 0.09, "multiplier": 2180, "color": "#80ffff"}, //cyan
               {"title":"eat a single banana ( bir eded banan yemek)", "measurement": 0.1, "multiplier": 1965, "color": "#8095ff"}, //blue
               {"title":"receive a dental x-ray ( dis rentgeninden kecmek)", "measurement": 5, "multiplier": 39, "color": "#d480ff"}, //purple
               {"title":"be on one airline flight from NY to LA ( Nyu-Yorkdan Los-Angelese bir ucus etmek)", "measurement": 40, "multiplier": 4.9, "color": "#ff80bf"}, //pink
               {"title":"sleep directly ontop of a nuclear plant for a year ( 1 il erzinde nuve stansiyasinin duz ustunde yatmaq)", "measurement": 250, "multiplier": 0.78,"color": "#ffaa80"}, //orange
               {"title":"receive a single mamogram ( bir defe mamogram (sine yoxlanisi) etdirmek)", "measurement": 400, "multiplier": 0.49, "color": "#eaff80"}, //yellow
               {"title":"receive a single chest CT scan( bir defe tomografiyadan kecmek) (micro-sieverts = milli-sievert)", "measurement": 7000, "multiplier": 0.028, "color": "#80ff80"} //green
            ];
